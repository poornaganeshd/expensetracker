  ...
  const submit = async () => {
    ...
    try {
      ...
      if (type !== "transfer" && receiptPickerRef.current?.count > 0) {
        ...
        if (urls.some(u => typeof u === "string" && u.startsWith("data:")) && onLocalReceipt) onLocalReceipt();
      }
